<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="javax.servlet.http.HttpSession,javax.servlet.http.HttpServletRequest,com.amzi.bean.Customer" %>
<!DOCTYPE html>
<html>
<head>
...
<div class="navbar">
  ...
  <a href="AccountStmt.jsp">Account Statments</a>
  <a href="logout.jsp">Logout</a>
</div>
<center><h3 text-align="center">Customer-Search</h3></center>

<script>
function validateForm() {
  var x = document.forms["myForm"]["ws_ssn_id"].value;
  var y = document.forms["myForm"]["ws_cust_id"].value;
  if(x == "" && y == "")
	  {
	  alert("Enter Either One Value");
	  return false;
	  }
  if(x != "" && y != "")
  {
...
<p style="text-align:center;">*Either one of the details should be entered.</p><br>
<form action="CustomerServelet" name="myForm" method="post" onsubmit="return validateForm()" align="center">
<table align="center">

    <tr>
		<td>Enter SSN ID<span style="color:red;">*</span></td>
		<td><input type="text" name="ws_ssn_id" id="1" pattern="^\d{1,9}$"></td>
	</tr>
	<tr>
		<td></td><td>OR</td>
	</tr>
	<tr>
		<td>Enter Customer ID<span style="color:red;">*</span></td>
		<td><input type="text" name="ws_cust_id" id="2" pattern="^\d{1,9}$"></td>
	</tr>
	<tr>
		<td></td><td><br><br><input type="submit" name="action" value="Search"></td>
	</tr>
</table>
</form>
