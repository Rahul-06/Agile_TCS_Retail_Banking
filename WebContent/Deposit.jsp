...
<center><h3>DEPOSIT AMOUNT TO ACCOUNT NUMBER</h3></center>
<form action="Servelet3" method="post"  name="myForm" >
<table align="center">
<tr><td>Account No:</td><td><input type="text" name="no" pattern="\d{1,9}" required></td></tr>
<tr><td>Amount To Be Deposit:</td><td><input type="text" name="amount" pattern="\d{1,}" required></td></tr>
</table>
<br>
