...
<script>
function val()
{	var x = document.forms["frm"]["acnumber"].value;
	if(x == "")
	{
    ...
    <form action="SearchServelet" method="post" name="frm" action="Search">
      <table border="0" width="300" align="center">
        <tr><td colspan=2 style="font-size:12pt;" align="center">
        <h3>Search Account by Account Number</h3></td></tr>
        
         <tr><td><b>Account No</b></td>
          <td>: <input type="text" name="acnumber" id="acnumber" pattern="^\d{1,9}$">
        </td></tr>   	
              
        <tr><td colspan=2 align="center">
        <input  type="submit" name="submit" value="Search" onclick="return val()"></td></tr>
      </table>
    </form>
    <script>
function vals()
{	var x = document.forms["forom"]["ws_cust_id"].value;
	if(x == "")
	{
    ...
    <form action="SearchServelet2" method="post" name="forom" action="Search">
      <table border="0" width="300" align="center">
        <tr><td colspan=2 style="font-size:12pt;" align="center">
        <h3>Search Account By Customer Id</h3></td></tr>
        
        <tr><td><b>Customer Id</b></td>
          <td>: <input type="text" name="ws_cust_id" id="ws_cust_id" pattern="^\d{1,9}$">
        </td></tr>        
        <tr><td colspan=2 align="center">
        <input  type="submit" name="submit" value="Search" onclick="return vals()"></td></tr>
      </table>
    </form>
    <div class="footer">
  <div class="row">
