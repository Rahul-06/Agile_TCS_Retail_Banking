...
<script>
function val()
{	var x = document.forms["myForm"]["acnumber"].value;
	if(x == "")
	{
		alert("Enter Account");
		return false;
...
<center>
<h4>Enter Account Number to Delete</h4></center>
<form action = "AccountServelet" method="post" align="center" name="myForm">
	Account Number <input type="text" name="acnumber" id="1" pattern="\d{1,9}"><br><br><br>
	<input type="submit"  onclick="return val()" name="action" value="Delete Account">
</form>
<div class="footer">
  <div class="row">
