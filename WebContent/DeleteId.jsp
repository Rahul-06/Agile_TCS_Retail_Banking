...
<script>
function val()
{	var x = document.forms["myForm"]["ws_cust_id"].value;
	if(x == "")
	{
...
<center><h4>Enter Customer ID to Delete</h4></center>
<form action = "CustomerServelet" method="post" align="center" name="myForm">
	Customer Id <input type = "text" name = "ws_cust_id" pattern="^\d{1,9}$" required><br><br><br>
	<input type = "submit" onclick="return val()" name = "action" value = "Delete Id">
</form>
<div class="footer">
  <div class="row">
