...
%>
<h4><center>Update Customer</center></h4>
<form action="CustomerServelet" method="post" align="center">
<table align="center">
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="ws_cust_name" required></td>
	</tr>
	<tr>
		<td>Old Address</td>
		<td><%=c.getAddress() %></td>
	...
	<tr>
		...
		<td><input type="text" name="ws_adrs" required></td>
	</tr>
	<tr>
		<td>Old Age</td>
		<td><%=c.getAge() %></td>
	...
	<td><center><a href="UpdateId.jsp">Cancel</a></center></td></tr>
