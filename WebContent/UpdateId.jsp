...
<h4><center>Update ID</center></h4>
<form action = "CustomerServelet" method="post" align="center" name="myForm">
	Customer Id <input type = "text" name = "ws_cust_id" pattern="^\d{1,9}$" required><br><br>
	<input type = "submit" name = "action" value = "Update Id" onclick="return val()">
</form>
<div class="footer">
  <div class="row">
