...
<center><h3>WITHDRAW AMOUNT FROM ACCOUNT NUMBER</h3></center>
<form action="Servelet1" method="post"  name="myForm" >
<table align="center">
<tr><td>Account No:</td><td><input type="text" name="no" pattern="\d{1,9}" required></td></tr>
<tr><td>Amount To Be Withdrawn:</td><td><input type="text" name="amount" pattern="\d{1,}" required></td></tr>
</table>
<br>
